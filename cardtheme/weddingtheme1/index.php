...
<?php session_start(); 
     if(!empty($_SESSION)){?>
     <input type='hidden' id='u' value='<?php echo $_SESSION['sessData']['user_id'];?>'> 
     <?php }?>
    ...
    <div class="container" id="test2">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">Bride Name&amp; GROOM Name</strong></h2>
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">|| Shri Ganeshaya Namah || 
<div>&nbsp;Smt. xyz cordially request the pleasure of your gracious presence on the auspicious occasion of the marriage ceremony of their Grand Daughter/Son</div></h3>
        ...
        <div class="media-container-row">
            <div class="card p-3 col-12 col-md-6">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="assets/images/sadhi-255x255.jpg" alt="Mobirise" title="" media-simple="true">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title pb-3 mbr-fonts-style display-5"><em>Bride Name</em></h4>
                        <p class="mbr-text mbr-fonts-style display-7">D/o , S/o Smt ABC From India</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card p-3 col-12 col-md-6">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="assets/images/sadhi2-255x255.jpg" alt="Mobirise" title="" media-simple="true">
                    </div>
                    <div class="card-box ">
                        <h4 class="card-title pb-3 mbr-fonts-style display-5"><em>Groom Name</em></h4>
                        <p class="mbr-text mbr-fonts-style display-7">D/o , S/o Smt ABC From India</p>
                    </div>
                </div>
            </div>
            ...
            <div class="media-content">
                ...
                <div class="mbr-section-text mbr-white pb-3 ">
                    <p class="mbr-text mbr-fonts-style display-7">
                        We request the honor of your presence at the wedding ceremony of our daughter Name with the Name. We request for your warm presence to bless the united couple for their happier married life.<br><br>Sincerely,<br>Smt. Mother Name&nbsp;&amp;&nbsp;Sh. Father Name<br>
                    </p>
                </div>
...
<section class="mbr-section content4 cid-qBNy5Q8qzx" id="content4-g" data-rv-view="283">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">Marriage Place</h2>
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">&nbsp;Marriage Garden
<div>Address, India
</div><div>Ph.985888888888, 985555555
</div><div>Note : Barat will arrive from residence of Shri abc from Jaipur.
                </div></h3>
...
<section class="mbr-gallery mbr-slider-carousel cid-qBNsOlCftS" id="gallery1-a" data-rv-view="287" >
    ...
    <div class="container">
        <div><!-- Filter --><!-- Gallery --><div class="mbr-gallery-row"><div class="mbr-gallery-layout-default"><div><div><div class="mbr-gallery-item mbr-gallery-item--p0" data-video-url="false" data-tags="Awesome"><div href="#lb-gallery1-a" data-slide-to="0" data-toggle="modal"><img src="assets/images/engagement-party-370x300-370x300.jpg" alt=""><span class="icon-focus"></span></div></div><div class="mbr-gallery-item mbr-gallery-item--p0" data-video-url="false" data-tags="Awesome"><div href="#lb-gallery1-a" data-slide-to="1" data-toggle="modal"><img src="assets/images/birthdaycard-370x300-370x300.jpg" alt=""><span class="icon-focus"></span></div></div><div class="mbr-gallery-item mbr-gallery-item--p0" data-video-url="false" data-tags="Responsive"><div href="#lb-gallery1-a" data-slide-to="2" data-toggle="modal"><img src="assets/images/c2-240x187-240x187.jpg" alt=""><span class="icon-focus"></span></div></div><div class="mbr-gallery-item mbr-gallery-item--p0" data-video-url="false" data-tags="Animated"><div href="#lb-gallery1-a" data-slide-to="3" data-toggle="modal"><img src="assets/images/c3-240x187-240x187.jpg" alt=""><span class="icon-focus"></span></div></div></div></div><div class="clearfix"></div></div></div><!-- Lightbox --><div data-app-prevent-settings="" class="mbr-slider modal fade carousel slide" tabindex="-1" data-keyboard="true" data-interval="false" id="lb-gallery1-a"><div class="modal-dialog"><div class="modal-content"><div class="modal-body"><div class="carousel-inner"><div class="carousel-item"><img src="assets/images/engagement-party-370x300.jpg" alt=""></div><div class="carousel-item"><img src="assets/images/birthdaycard-370x300.jpg" alt=""></div><div class="carousel-item"><img src="assets/images/c2-240x187.jpg" alt=""></div><div class="carousel-item active"><img src="assets/images/c3-240x187.jpg" alt=""></div></div><a class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#lb-gallery1-a"><span class="mbri-left mbr-iconfont" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control carousel-control-next" role="button" data-slide="next" href="#lb-gallery1-a"><span class="mbri-right mbr-iconfont" aria-hidden="true"></span><span class="sr-only">Next</span></a><a class="close" href="#" role="button" data-dismiss="modal"><span class="sr-only">Close</span></a></div></div></div></div></div>
    </div>
    ...
    <div class="container align-center"  id="test5">
        ...
        <div class="team-item col-lg-3 col-md-6">
                <div class="item-image">
                    <img src="assets/images/function2-255x255.jpg" alt="" title="" media-simple="true">
                </div>
                <div class="item-caption py-3">
                    ...
                    <div class="item-role px-2">
                        <p> Day and Date with time</p>
                    </div>
                    
                </div>
            </div><div class="team-item col-lg-3 col-md-6">
                <div class="item-image">
                    <img src="assets/images/function-255x255.jpg" alt="" title="" media-simple="true">
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p class="mbr-fonts-style display-5">
                ...
                <div class="item-image">
                    <img src="assets/images/inauguration-255x255.jpg" alt="" title="" media-simple="true">
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p class="mbr-fonts-style display-5">
                ...
                <div class="item-image">
                    <img src="assets/images/sadhi2-255x255.jpg" alt="" title="" media-simple="true">
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p class="mbr-fonts-style display-5">
                        ...
                        <div class="row row-sm-offset">
                            <div class="col-md-4 multi-horizontal" data-for="name">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" data-form-field="Name" ="" id="name-form1-e">
                                </div>
                            </div>
                            <div class="col-md-4 multi-horizontal" data-for="email">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="email-form1-e">Address</label>
                                    <input type="email" class="form-control" name="email" data-form-field="Email" ="" id="email-form1-e">
                                </div>
                            </div>
...
<section class="cid-qBNwJlhjBK" id="footer2-f" data-rv-view="324">
    ...
    <h4><a href="../../formcard/cardform.php "> Create Your Theme click Here</a></h4>
</section>
