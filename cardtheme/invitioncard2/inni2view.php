...
<section class="mbr-section mbr-section-hero mbr-section-full header2 mbr-parallax-background mbr-after-navbar" id="header2-3" data-rv-view="7" style="background-image: url(assets/images/landscape.jpg);">
                ...
                <div class="mbr-section row">
                    <div class="mbr-table-md-up">
                        ...
                        <div class="mbr-table-cell col-md-5 content-size text-xs-center text-md-right">
                            ...
                            <h3 class="mbr-section-title display-2"><?php echo $groom_name ?>

                            <?php echo $banner_message ?> </h3>
                        ...
                        <div class="mbr-table-cell mbr-valign-top mbr-left-padding-md-up col-md-7 image-size" style="width: 50%;">
                            <div class="mbr-figure">  <img src="<?php echo '../wedding1/images/'.$groom_photo; ?>" width="100%" height="100%"  title="" media-simple="true"/></div>
                        </div>
    ...
    <div class="container" id="test2">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                ...
                <div class="lead"><p><span style="font-size: 1.07rem;"><?php echo $marriage_placeaddress ?></span><br></p><p><?php echo $marriage_place ?>
</p><p><?php echo $phone_one?> <?php echo $phone_two ?>
</p><p>.</p></div>
