...
<a class="btn btn-danger" href="?delete_id=<?php echo $row['user_id']; ?>" title="click for delete" onclick="return confirm('sure to delete ?')">
 ...
 <a  class="btn btn-primary"  href="../wedding1/payment.php">Buy it</a>
