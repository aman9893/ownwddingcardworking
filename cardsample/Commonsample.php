            ...
            <div class="media-container-row">
                <div class="title col-12 col-md-8">
                    <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-2"><span style="font-weight: normal;"> 
                        ...
                        Common Function </span></h2>
                    <h3 class="mbr-section-subtitle align-center mbr-light mbr-white pb-3 mbr-fonts-style display-5">
                  Common Function Digital Card</h3>
    ...
    <div class="container align-center">
        ...
        <div class="team-item col-lg-4 col-md-8">
                <div class="item-image">
                    <a href="../cardtheme/invition/index.html"><img src="images/par.jpg" alt="" title="" media-simple="true"></a>
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p >

 <a href="../cardtheme/invition/index.html">&emsp; Common Function Theme 1</a>
 <br>
...
<br/>
 <input type="button" class="btn btn-sm btn-primary display-4"  value=' CREATE AND PREVIEW ' onclick="bday_val();"/>
                   ...
                   <div class="team-item col-lg-4 col-md-8">
                   <div class="item-image">
                    <a href="../cardtheme/function event/index.html"><img src="images/ino3.jpg" alt="" title="" media-simple="true"></a>
                    </div>
                   <div class="item-caption py-3">
                    <div class="item-name px-2">
                    <p >
                    
                     <a href="../cardtheme/function event/index.html">&emsp; Common Function Theme 2</a>
                     <br>
                    </div>
                    <br>
