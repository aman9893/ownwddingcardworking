        ...
        <div class="container">
            <div class="media-container-row">
                <div class="title col-12 col-md-8">
                    <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-2"><span style="font-weight: normal;"> BIRTHDAY CRAD THEME</span></h2>
    ...
    <div class="container align-center">
        ...
        <div class="team-item col-lg-4 col-md-8">
                <div class="item-image">
                    <a href="../cardtheme/invition/index.html"><img src="images/bs.jpg" alt="" title="" media-simple="true"></a>
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p >

 <a href="../cardtheme/invition/index.html">&emsp; Bday Theme 1</a>
 <br>
...
<br/>
 <input type="button"  class="btn btn-sm btn-primary display-4"  value=' CREATE AND PREVIEW ' onclick="bday_val();"/>
                   ...
                   <div class="team-item col-lg-4 col-md-8">
                   <div class="item-image">
                    <a href="../cardtheme/invitioncard2/index.html"><img src="images/traditional-birthday-celebration-its-signs-and-features.jpg" alt="" title="" media-simple="true"></a>
                    </div>
                   <div class="item-caption py-3">
                    <div class="item-name px-2">
                    <p >
                    
                     <a href="../cardtheme/invitioncard2/index.html">&emsp; Bday Theme 2</a>
                     <br>
                    </div>
                    <br>
